    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <hr>
                <p>
                    <a href="http://android-libs.com/send" class="btn btn-block btn-primary" target="_blank"><i class="fa fa-fw fa-send-o"></i> Submit an other library on AndroidLibs.com</a>
                </p>
            </div>
        </div>
    </div>
